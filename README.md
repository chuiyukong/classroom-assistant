...
**当前版本：1.8.0 · 本地部署 · 教师机 Windows 10 x64 · 学生机 Win7 Chrome / Firefox**
...
1. 下载 `ClassroomAssistant-v1.8.0-Win10-x64.zip`，完整解压，关闭旧程序后双击 `ClassroomAssistant.exe`。
...
![工作方式与技术架构](docs/images/architecture.png)

[查看可放大的矢量图](docs/images/architecture.svg)
